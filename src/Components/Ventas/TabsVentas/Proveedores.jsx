...
const Proveedores = () => {
  const columnasStock = ['Estado', 'Proveedor', 'Fecha', 'Importe', 'Caja', 'Op.'];
  const itemsStock = [
    {
    ...
    <div className='proveedores-container'>
      <div>
        ...
        <div className='proveedores-top-box'>
          ...
          <div>
            <input className='proveedores-input' type='date' placeholder='dd/mm/aaaa' />
          ...
          <div>
            <h4>
              ...
              <span style={{ color: '#D4674A', marginLeft: '15px' }}>-$6565</span>
            </h4>
          </div>
        </div>
