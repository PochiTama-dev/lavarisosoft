    ...
    <Popup>
      ...
      <div className='popup-tecnico-button'>
        <button onClick={onTechnicianSelect}>
          <svg xmlns='http://www.w3.org/2000/svg' width='22' height='22' fill='currentColor' className='bi bi-arrow-right'>
...
export const ClientMarker = ({ cliente, handleOpenModalWithClientData, handleCoordinates }) => (
  <Marker position={[cliente.latitud, cliente.longitud]} icon={clienteIcono} eventHandlers={{ click: () => handleCoordinates(cliente) }}>
    <Popup>
      <div className='popup-tecnico'>
