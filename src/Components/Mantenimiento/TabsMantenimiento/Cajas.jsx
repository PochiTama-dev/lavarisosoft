      ...
      <Table striped hover>
        ...
        <tbody>
          {listaCajas.map((caja, index) => (
            <tr key={index}>
              <td>{displayValue(caja.denominacion)}</td>
              <td>{displayValue(caja.cuenta)}</td>
              <td>{displayValue(caja.codigo_imputacion)}</td>
              <td>{displayValue(caja.pesos, "$")}</td>
              <td>{displayValue(caja.dolares, "US$ ")}</td>
              <td>{displayValue(caja.banco, "$")}</td>
            </tr>
          ))}
        </tbody>
      </Table>
