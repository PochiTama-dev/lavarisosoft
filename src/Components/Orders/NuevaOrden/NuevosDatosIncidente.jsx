        ...
        <div className='col-md-6'>
          ...
          <div className='mb-3 row align-items-center'>
            ...
            <div className='col-sm-8'>
              <input type='text' id='numero_orden' className='form-control input-small' value={numeroOrden} onChange={handleInputChange} readOnly required />
            </div>
          </div>
          <div className='mb-3 row align-items-center'>
          ...
          {showMore && (
            <>
              ...
              <div className='mb-3 row align-items-center'>
                <label htmlFor='fecha_visita' className='col-sm-2 col-form-label'>
                  Fecha de Visita:
                </label>
                <div className='col-sm-8'>
                  <input type='date' id='fechaVisita' className='form-control input-small' value={fechaVisita} onChange={handleFechaVisitaChange} required />
                </div>
              </div>
              ...
              <Modal open={isModalOpen} onClose={handleCloseModal} className='modal'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    <h5 className='modal-title'>{isSelectingStartTime ? 'Selecciona la Hora de Inicio' : 'Selecciona la Hora de Fin'}</h5>
                  </div>
                  <div className='modal-body'>
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      {isSelectingStartTime ? (
                        <TimeClock ampm={false} key={timeClockKey} value={horaInicioVisita} onChange={handleHoraInicioVisitaChange} />
                      ) : (
                        <TimeClock ampm={false} key={timeClockKey} value={horaFinVisita} onChange={handleHoraFinVisitaChange} />
                      )}
