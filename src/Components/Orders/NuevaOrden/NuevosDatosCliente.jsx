...
const NuevosDatosCliente = ({ setCliente, cliente }) => {
  ...
  const [NewNumeroCliente, setNewNumeroCliente] = useState();
  ...
  const getClientes = async () => {
    ...
    const maxNumero = allClients.reduce((max, client) => {
      return client.numero_cliente > max ? client.numero_cliente : max;
    }, -Infinity);

    setNewNumeroCliente(maxNumero);
  };
  ...
  return (
    <div style={{ marginTop: '6%', marginLeft: '2%' }}>
      ...
      <div className='row'>
        {selectedClient && (
          <>
            <select className='col-sm-3 text-left' style={{ marginBottom: '1%' }}>
        ...
        <div className='row'>
          <div className='col-md-6'>
            ...
            <div className='mb-3 row align-items-center'>
              ...
              <div className='col-sm-8'>
                <input type='text' id='numero_cliente' className='form-control input-small' value={NewNumeroCliente + 1} disabled required />
              </div>
            </div>
            <div className='mb-3 row align-items-center'>
              <label htmlFor='nombre' className='col-sm-2 text-left'>
          ...
          <div className='col-md-6'>
            ...
            <div className='mb-3 row align-items-center'>
              ...
              <div className='col-sm-8'>
                <input type='text' id='direccion' className='form-control input-small' value={ubicacion} onChange={handleSuggestions} required />
              </div>
            ...
            {/* <div className='mb-3 row align-items-center'>
              ...
              <div className='col-sm-8'>
                <input type='text' id='ubicacion' className='form-control input-small' value={cliente.localidad || ''} required />
              </div>
            </div> */}
          </div>
        </div>
