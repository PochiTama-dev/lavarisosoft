...
const RemitoOrden = () => {
  ...
  const { numero_orden, Cliente = {}, Empleado = {}, equipo = '', modelo = '', antiguedad = '', diagnostico = '', Presupuesto = {} } = orden;
  const handlePrint = () => {
    window.print();
  };
  return (
    <div className='remito-container'>
      ...
      <div className='remito-container-content'>
        ...
        <svg width='1829' height='5' viewBox='0 0 1829 5' fill='none' xmlns='http://www.w3.org/2000/svg'>
