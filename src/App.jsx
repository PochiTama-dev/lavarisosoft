  ...
  return (
    <Routes>
      ...
      <Route
        element={
          <PrivateRoute
            roles={["Atención al cliente", "Super administrador"]}
          />
        }
      >
      ...
      <Route
        element={
          <PrivateRoute
            roles={["Contable administrativo", "Super administrador"]}
          />
        }
      >
        {/* Rutas Ordenes */}
        ...
        <Route
          path="/agregarPlanCuentasExcel"
          element={<AddPlanCuentasExcel />}
        />
      ...
      <Route
        element={
          <PrivateRoute roles={["Jefe de taller", "Super administrador"]} />
        }
      >
        <Route path="/taller" element={<Taller showHeader={true} />} />
        <Route
          path="/liquidacionPresupuestos"
          element={<LiquidacionPresupuestos />}
        />
        <Route
          path="/editarStockRepuestos"
          element={<EditarStockRespuestos />}
        />
        <Route
          path="/editarStockRepuestos/editarProducto/:id"
